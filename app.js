...
bot.on("ready", async () =>{
  ...
  bot.user.setActivity("Natsuki#6475 to moja siostra <3; !pomoc", {type: "LISTENING"});
})
...
channel.send('Propozycja' + args.join(' '))  + '\nPropozycja od użytkownika:' + message.author//Sends the arguments
